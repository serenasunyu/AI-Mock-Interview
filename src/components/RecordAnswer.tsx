...
const RecordAnswer = ({
  ...
  const cleanJsonResponse = (responseText: string) => {
    ...
    // step2: remove any occurrences of json or code block symbols(``` or `)
  ...
  return (
    <div className="w-full flex flex-col items-center gap-8 mt-4">
        ...
        <div className="w-full h-[400px] md:w-96 flex flex-col items-center 
        justify-center border p-4 bg-gray-50 rounded-md">
            {isWebCam ? (
                <Webcam
